...
import { ComplianceAnalysisResult } from '@/lib/types/api.types'; // <-- Updated path
...
// Handle HMR
export default mongoose.models.ComplianceAnalysis || mongoose.model<IComplianceAnalysis>('ComplianceAnalysis', ComplianceAnalysisSchema); 